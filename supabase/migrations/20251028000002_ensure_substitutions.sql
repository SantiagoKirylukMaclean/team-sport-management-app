-- 20251028000002_ensure_substitutions.sql
-- Asegurar que la tabla y funciones de sustituciones existan
...
-- 4) Recrear policies (drop si existen)
...
-- 5) Recrear función apply_match_substitution
...
-- 6) Recrear función remove_match_substitution
...
grant execute on function public.apply_match_substitution(bigint, smallint, bigint, bigint) to authenticated;
grant execute on function public.remove_match_substitution(bigint, smallint, bigint, bigint) to authenticated;
