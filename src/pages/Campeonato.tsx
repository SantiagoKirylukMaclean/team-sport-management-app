...
import { CampeonatoDetailDialog } from './components/CampeonatoDetailDialog'
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Información completa de partidos y resultados del campeonato
        </p>
      </div>
